...
<template>
	<div>
		...
		<!-- Dashboard Layout -->
		<a-layout class="layout-dashboard" id="layout-teacher" :class="[navbarFixed ? 'navbar-fixed' : '', ! sidebarCollapsed ? 'has-sidebar' : '', layoutClass, sidebarMinimized ? 'sidebar-minimized' : '' ]">
...
<script>
	...
	import FacSidebar from '../components/Sidebars/FacSidebar.vue' ;
